...
export const dict = {
  ...
  "session.location.description": "选择另一个目录以继续此会话。",
  ...
  "dialog.server.menu.hide": "从项目列表隐藏",
  "dialog.server.menu.show": "在项目列表显示",
  "server.row.incompatible": "此服务器运行的是 OpenCode {{version}}，与本应用不兼容。请将其升级到 OpenCode V2 以继续。",
  "toast.session.copyID.failed.title": "复制会话 ID 失败",
  "toast.session.copyID.failed.description": "复制会话 ID 时发生错误",
  "toast.project.copyID.failed.title": "复制项目 ID 失败",
  "toast.project.copyID.failed.description": "复制项目 ID 时发生错误",
  "toast.migration.failed.title": "数据迁移失败",
  "error.page.title.status": "服务器请求失败",
  "error.page.description.status": "服务器返回 HTTP {{status}} 响应。",
  "error.page.action.reload": "重新加载",
  "home.projects.all": "所有项目",
  "home.workspaceTip": "在新的工作树中开始下一个会话，以保持更改相互隔离",
  ...
  "session.error.incompatible.description": "{{server}} 运行的是 OpenCode {{version}}，与本应用不兼容。请将服务器升级到 OpenCode V2 以继续。",
  "session.background.moveTasks": "将 {{tasks}} 移至后台",
  "session.background.moveRunning": "移至后台",
  "session.background.inBackground": "正在后台运行 {{tasks}}",
  "session.background.moveInline": "按 {{keybind}} 将运行中的工作移至后台",
  "session.background.running": "正在后台运行工作",
  "session.background.runningCount.one": "{{count}} 项正在后台运行",
  "session.background.runningCount.other": "{{count}} 项正在后台运行",
  ...
  "session.queue.count.one": "{{count}} 排队中",
  "session.queue.count.other": "{{count}} 排队中",
  "session.queue.steer": "引导",
  "session.queue.send": "发送",
  "session.queue.steerTooltip": "发送但不打断当前回合",
  "session.queue.remove": "移除",
  "session.queue.reorder": "重新排序排队的提示词",
  ...
  "session.websearch.description": "选择代理在搜索网页时使用的搜索提供商",
  ...
  "settings.tab.experimental": "实验功能",
  "settings.experimental.description": "试用实验性功能",
  "settings.tab.about": "关于",
  "settings.about.version": "版本 {{version}}",
  "settings.about.devVersion": "开发版",
  "settings.about.license": "在 MIT 许可证下发布",
  "settings.about.writtenBy": "作者",
  "settings.about.illustratedBy": "插画",
  "settings.about.and": "和",
  "settings.about.otherContributor.one": "其他 {{count}} 位贡献者",
  "settings.about.otherContributor.other": "其他 {{count}} 位贡献者",
  "settings.about.firstPublished": "首次发布于美国密苏里州",
  "settings.about.firstIllustrated": "首次插画于英国伦敦",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode，开源编程代理",
  "settings.about.trademark": "OpenCode 是 Anomaly Innovations, Inc. 的注册商标",
  "settings.about.typeset": "排版字体为 Inter 与 IBM Plex Mono",
  "settings.about.tagline": "没有你，AI 也无法构建出色的软件",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "settings.preferences.description": "自定义偏好、主题与默认行为",
  "settings.appearance.description": "自定义主题与字体",
  "settings.appearance.section.experimental": "实验功能",
  ...
  "project.settings.general.description": "管理项目名称与外观",
  ...
  "settings.timeline.detail": "时间线详细程度",
  "settings.timeline.description": "选择会话时间线中显示的详细程度。",
  ...
  "settings.timeline.description.everything": "分别显示所有活动。展开 shell 输出、编辑和思考。",
  "settings.timeline.description.detailed": "展开 shell 输出与编辑。单独显示子代理，并将其他活动分组。",
  "settings.timeline.description.compact": "将所有活动分组并折叠详情。",
  "settings.timeline.description.quiet": "对编辑和子代理分组。隐藏其他活动。",
  "settings.timeline.description.text-only": "隐藏所有活动。",
  "settings.timeline.description.custom": "使用高级设置。",
  "settings.timeline.custom": "自定义",
  "settings.timeline.advanced": "高级",
  "settings.timeline.advanced.description": "为每个活动类别设置位置与详情。",
  ...
  "settings.general.row.browserPane.title": "浏览器面板",
  ...
  "settings.general.row.mobileDiffWrap.description": "在移动端差异视图中自动换行长行，而不是横向滚动",
  "settings.general.row.followUpBehavior.title": "后续行为",
  "settings.general.row.followUpBehavior.description": "选择是排队后续任务还是引导当前回合。使用 {{keybind}} 切换。",
  ...
  "settings.workspaces.empty": "还没有工作树",
  ...
  "settings.workspaces.sessions.one": "{{count}} 个会话（位于 {{project}}）",
  "settings.workspaces.sessions.other": "{{count}} 个会话（位于 {{project}}）",
  "settings.workspaces.sessions.filtered.one": "{{count}} 个会话",
  "settings.workspaces.sessions.filtered.other": "{{count}} 个会话",
  "settings.workspaces.lastActiveSession": "最近活动的会话",
  "settings.workspaces.deleteAll": "删除所有工作树",
  "settings.workspaces.deleteAll.confirm.one": "这将永久删除 {{count}} 个选中的工作树。",
  "settings.workspaces.deleteAll.confirm.other": "这将永久删除 {{count}} 个选中的工作树。",
  ...
  "settings.workspaces.deleteWithoutSessions.warning": "包含未合并更改或活动位置的工作树将被保留。",
  "settings.workspaces.delete.button": "删除工作树",
  "settings.workspaces.delete.warning": "这将永久删除该工作树及其分支。",
  "settings.workspaces.deleteAll.warning": "包含未合并更改、关联会话或活动位置的工作树将被保留。",
  "settings.workspaces.delete.blocked.active": "无法删除正在使用的工作树。",
  "settings.workspaces.delete.blocked.linked": "关联的会话将保留，但其工作目录将不再存在。",
  "settings.workspaces.default.title": "默认环境",
  "settings.workspaces.default.description": "选择新会话的启动位置",
  "settings.workspaces.default.lastUsed": "每个项目上次使用",
  "settings.workspaces.default.local": "本地目录",
  "settings.workspaces.default.new": "新工作树",
  "workspace.move.title": "移动到工作树",
  ...
  "workspace.onboarding.description": "每个会话拥有独立的检出副本",
